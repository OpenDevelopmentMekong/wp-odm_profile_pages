...
if (!class_exists('Odm_Profile_Pages_Post_Type')) {
  ...
  Economic Land Concessions|https://cambodia.opendevelopmentmekong.net/profiles/economic-land-concessions/', 'wp-odm_profile_pages');
            ...
            ?></label></th>
  					  <td>
  								<input name="_link_to_detail_column" style="width:100%;height: 50px;"placeholder="Label of Link|URL"><?php echo $link_to_detail_column;
            ?></input>
  ...
  name,company,developer,block', 'wp-odm_profile_pages');
    ...
    ?></label></th>
  					  <td>
  							<textarea name="_link_to_detail_column_localization" style="width:100%;height: 50px;"placeholder="Lable of Link|URL"><?php echo $link_to_detail_column_localization;
    ?></textarea>
              <p class="description"><?php _e('Please add the ids of the columns that will feature a link to the entry\'s detail page. Format: Comma-separated values. <br/>eg.
          name,company,developer,block', 'wp-odm_profile_pages');
          ?></p>
